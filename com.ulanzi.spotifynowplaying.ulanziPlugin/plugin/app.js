...
import * as muteToggle from './actions/muteToggle.js';
...
$UD.onAdd((msg) => {
  ...
  muteToggle.add(context, actionType);
});
...
function onTrigger(msg) {
  ...
  else if (muteToggle.handles(actionType)) muteToggle.run(context);
